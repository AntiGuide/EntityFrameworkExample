...
namespace ClientServer.Client {
    ...
    class Program {
        ...
        /// </summary>
        private const int EVENT_NAMES = 100;
        ...
        void TestMethodsCreate() {
            ...
            for (var i = 0; i < GAME_SESSIONS; ++i) {
                ...
                for (var j = 0; (newEventIndex < EVENT_NAMES) && (j < MAX_EVENTS_PER_SESSION); ++j) {
        ...
        static void Main(string[] args) {
            using (var consumer = new Consumer()) {
                ...
                p.TestMethodsCreate();
                p.TestMethodGetAllEventsOrderedByCountDesc();
                p.TestMethodGetNextEventsOrderedByCountDesc();
                p.TestMethodGetLastEventsOrderedByCountDesc();
            }
